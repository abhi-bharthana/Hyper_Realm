...
import { useSidebarStore } from '../../store/useSidebarStore'; // 🔥 FIX: Naya store import kiya

export function SidebarSection() {
  // 🔥 FIX: useAppStore ki jagah useSidebarStore use kar rahe hain
  const { isSidebarAutoHide, setSidebarAutoHide } = useSidebarStore();
